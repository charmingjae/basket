...
module.exports = {
  api: {
    ...
    getMyinfo: (req, res) => {
      ...
      model.api.getMyinfo(body, (data) => {
        res.send(data);
      });
    },
    getBorrowlist: (req, res) => {
      model.api.getBorrowlist((data) => {
        return res.send(data);
      });
    },
    returnbook: (req, res) => {
      ...
      model.api.returnbook(body, () => {
        res.send(true);
      });
    },
    getOverduelist: (req, res) => {
      model.api.getOverduelist((data) => {
        return res.send(data);
      });
    },
    finoverdue: (req, res) => {
